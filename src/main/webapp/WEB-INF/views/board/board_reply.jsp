...
<table width="750" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<td align="center"><img src="${ pageContext.request.contextPath }/resources/img/btn_reg.gif" onClick="return send_check();" style="cursor:hand">
		<img src="${ pageContext.request.contextPath }/resources/img/btn_back.gif" onClick="JavaScript:location.href='list.do'" style="cursor:hand"></td>
	</tr>
</table>
